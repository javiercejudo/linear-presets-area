...
describe('area presets', function() {
  it('should convert correctly', function() {
    (5.045e+9).should.be.exactly(convert(5045, invert(area.squareMetre_squareKilometre)), 'squareMetre_squareKilometre')
    ...
    (0).should.be.exactly(convert(0, area.squareMetre_squareKilometre), 'squareMetre_squareKilometre')
